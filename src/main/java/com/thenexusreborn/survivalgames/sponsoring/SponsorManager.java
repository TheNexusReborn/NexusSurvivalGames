...
public class SponsorManager {
    ...
    public SponsorManager() {
        this.foodCategory = new ItemSponsorCategory("Food", SMaterial.COOKED_BEEF);
        ...
        this.weaponCategory = new ItemSponsorCategory("Weapon", SMaterial.WOODEN_SWORD);
        ...
        this.armorCategory = new ItemSponsorCategory("Armor", SMaterial.LEATHER_CHESTPLATE);
        ...
        this.potionCategory = new PotionSponsorCategory("Potion Effect", SMaterial.GLASS_BOTTLE);
