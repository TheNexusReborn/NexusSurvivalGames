...
public class TierTwoLootTable extends SGLootTable {
    ...
    public void loadDefaultData() {
        ...
        addItems(15, Items.GOLDEN_MUNCHIE);
        ...
        addItems(30, Items.EGG_OF_DOOM, Items.SLOWBALL, Items.XP_BOTTLE, Items.ENDER_PEARL);
        ...
        addItems(10, Items.GOLD_INGOT, Items.IRON_INGOT);
