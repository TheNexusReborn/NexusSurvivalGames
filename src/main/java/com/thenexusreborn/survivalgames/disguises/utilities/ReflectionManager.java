...
public class ReflectionManager {
    ...
    public enum LibVersion {
        ...
        V1_8;
        private static final LibVersion currentVersion;
            ...
            try {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (fieldMatcher.matches()) {
                        // by CB class name
                        Map<String, String> innerMap = ForgeFieldMappings.computeIfAbsent(dir2fqn(fieldMatcher.group(3)), k -> new HashMap<>());
                    ...
                    if (methodMatcher.matches()) {
                        ...
                        Map<String, Map<String, String>> middleMap = ForgeMethodMappings.computeIfAbsent(dir2fqn(methodMatcher.group(5)), k -> new HashMap<>());
    ...
    public static Object createEntityInstance(String entityName) {
        try {
            ...
            switch (entityName) {
                ...
                default -> entityObject = entityClass.getConstructor(getNmsClass("World")).newInstance(world);
            }
            return entityObject;
        } catch (Exception e) {
            e.printStackTrace(System.out);
        ...
        try {
            ...
            for (Field field : boundingBox.getClass().getFields()) {
                if (field.getType().getSimpleName().equals("double")) {
                    stage++;
                    switch (stage) {
                        case 1 -> x -= field.getDouble(boundingBox);
                        case 2 -> y -= field.getDouble(boundingBox);
                        case 3 -> z -= field.getDouble(boundingBox);
                        case 4 -> x += field.getDouble(boundingBox);
                        case 5 -> y += field.getDouble(boundingBox);
                        case 6 -> z += field.getDouble(boundingBox);
                        default ->
