...
public enum DisguiseSound {
    ...
    private final HashSet<String> cancelSounds = new HashSet<>();
    private float damageSoundVolume = 1F;
    private final HashMap<SoundType, String> disguiseSounds = new HashMap<>();
    ...
    DisguiseSound(Object... sounds) {
        for (int i = 0; i < sounds.length; i++) {
            ...
            switch (i) {
                case 0 -> disguiseSounds.put(SoundType.HURT, s);
                case 1 -> disguiseSounds.put(SoundType.STEP, s);
                case 2 -> disguiseSounds.put(SoundType.DEATH, s);
                case 3 -> disguiseSounds.put(SoundType.IDLE, s);
                default -> cancelSounds.add(s);
            }
        }
    }
